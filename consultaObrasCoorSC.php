...
<head>
	<meta charset="utf-8"/>
	<title>Obras</title><!-- Consulta del Coor sin croquis -->
...
<script>
 $(document).ready(function() {
	oTableSC = $('#dataTableCoorscr').dataTable({
...
<div id="obrasTodas">  	
				<table cellpadding="0px" cellspacing="0px" border="1px solid black" bordercolor="#EEEEEE" id="dataTableCoorscr">
					 <thead>
            <tr>
