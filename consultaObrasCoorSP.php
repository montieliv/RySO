...
<head>
	<meta charset="utf-8"/>
	<title>Obras</title> <!-- Consulta del Coor sin presupuesto -->
...
<script>
 $(document).ready(function() {
	oTableSP = $('#dataTableCoorsp').dataTable({
...
<div id="obrasTodas">  	
				<table cellpadding="0px" cellspacing="0px" border="1px solid black" bordercolor="#EEEEEE" id="dataTableCoorsp">
					 <thead>
            <tr>
             ...
             <?php  
                  ...
                  while( $pp = mysql_fetch_array($numtodos) )
                     { ?>
                               ...
                               <script> //alert("<?php echo $obrpre['0'];?>");</script>
                                <?php if ($obrpre['0'] <= 0) { ?>
                                <tr>  
                         ...
                         while( $nI2 = mysql_fetch_array($obtenergestor) )
                                  ...
                                  if ($pp['tipoObra']=="Nueva") {$cantdias=90;} else {$cantdias=30;}
                                        ...
                                        $fechafin=calculafecha($pp['croquisalcien'],$cantdias);
                                         $dias=restarFechas(date('Y-m-d'),$fechafin);                                              
                                         $habiles=calculafechahabil(date('Y-m-d'),$dias);                                         
                                         $ix++; ?>
                                        ...
                                        <?php
                                              ...
                                              if ($porcentaje  <= 19) 
                                                     { 
                                                       if ($porcentaje >= 0) {
                                                       ?>
                                                          <script> activarR(<?php echo $ix ?>);</script>                          
                                                <?php   } else { ?>
                                                        ...
                                                        { ?>
                                                             <script> activarA(<?php echo $ix ?>);</script> 
                                                  <?php }
                                                         else { ?>
